  ...
  for (;;) {
    try {
      ...
      if (/unterminated/i.test(msg)) {
        ...
        if (/string/.test(msg)) {
          replace = { start: e.pos, end: pos, type: _acorn.tokTypes.string, value: this.input.slice(e.pos + 1, pos) };
      ...
      this.resetTo(pos);
      if (replace === true) replace = { start: pos, end: pos, type: _acorn.tokTypes.name, value: "✖" };
      if (replace) {
