...
lp.parseMaybeAssign = function (noIn) {
  ...
  if (this.tok.type.isAssign) {
    ...
    _node.left = this.tok.type === _acorn.tokTypes.eq ? this.toAssignable(left) : this.checkLVal(left);
    this.next();
...
lp.parseSubscripts = function (base, start, noCalls, startIndent, line) {
  for (;;) {
    if (this.curLineStart != line && this.curIndent <= startIndent && this.tokenStartsLine()) {
      if (this.tok.type == _acorn.tokTypes.dot && this.curIndent == startIndent) --startIndent;else return base;
    }
    ...
    if (this.eat(_acorn.tokTypes.dot)) {
      ...
      _node6.callee = base;
      _node6.arguments = this.parseExprList(_acorn.tokTypes.parenR);
...
lp.parseObj = function () {
  ...
  while (!this.closes(_acorn.tokTypes.braceR, indent, line)) {
    ...
    if ((0, _parseutil.isDummy)(prop.key)) {
      if ((0, _parseutil.isDummy)(this.parseMaybeAssign())) this.next();this.eat(_acorn.tokTypes.comma);continue;
    }
    ...
    } else if (this.options.ecmaVersion >= 5 && prop.key.type === "Identifier" && !prop.computed && (prop.key.name === "get" || prop.key.name === "set") && this.tok.type != _acorn.tokTypes.comma && this.tok.type != _acorn.tokTypes.braceR) {
