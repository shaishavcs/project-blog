...
var _atomicBlock = require("../../components/atomicBlock");

var _defaults = require("../../components/atomicBlock/defaults");
...
var CommonBlock = function (_Component) {
  ...
  _createClass(CommonBlock, [{
    ...
    value: function render() {
      ...
      var options = this.props.blockProps.atomicBlock.options || {};
      options = _extends({}, defaults, options);

      return _react2.default.createElement(
        _atomicBlock.BlockWrapper,
        null,
        _react2.default.createElement(
          _atomicBlock.BlockControls,
          null,
          _react2.default.createElement(_Dropdown2.default, {
            items: options.displayOptions,
            selected: data.display || options.defaultDisplay,
            onChange: this._handleDisplayChange }),
          _react2.default.createElement(_atomicBlock.BlockActionGroup, { items: this.props.actions })
        ),
        this.props.children
      );
    }
