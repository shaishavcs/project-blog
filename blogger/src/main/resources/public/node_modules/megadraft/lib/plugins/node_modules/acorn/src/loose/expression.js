...
lp.parseExprAtom = function () {
  ...
  switch (this.tok.type) {
    ...
    case _index.tokTypes.num:case _index.tokTypes.string:
      node = this.startNode();
    ...
    case _index.tokTypes._null:case _index.tokTypes._true:case _index.tokTypes._false:
      node = this.startNode();
...
lp.parseObj = function () {
  ...
  while (!this.closes(_index.tokTypes.braceR, indent, line)) {
    ...
    if ((0, _parseutil.isDummy)(prop.key)) {
      if ((0, _parseutil.isDummy)(this.parseMaybeAssign())) this.next();this.eat(_index.tokTypes.comma);continue;
    }
