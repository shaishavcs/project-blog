...
exports.LooseParser = exports.pluginsLoose = undefined;
...
// Registered plugins
var pluginsLoose = exports.pluginsLoose = {};

var LooseParser = exports.LooseParser = function () {
  function LooseParser(input) {
    ...
    this.tok = this.last = { type: _index.tokTypes.eof, start: 0, end: 0 };
  ...
  _createClass(LooseParser, [{
    ...
    value: function dummyNode(type) {
      ...
      this.last = { type: _index.tokTypes.name, start: dummy.start, end: dummy.start, loc: dummy.loc };
      return dummy;
    }
  }, {
    key: "dummyIdent",
